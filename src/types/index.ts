export type Tab = 'home' | 'habit' | 'daily' | 'tasks' | 'youtube' | 'music' | 'tvshow' | 'books' | 'movies' | 'manga' | 'bl' | 'ngontinh' | 'truyenh' | 'english' | 'knowledge' | 'reviews' | 'tiktok' | 'money' | 'calendar' | 'people' | 'nutrition' | 'usage' | 'settings'
